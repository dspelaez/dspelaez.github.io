...
The consequences are severe and far-reaching. [Coral reefs bleach](https://doi.org/10.1016/j.scitotenv.2023.162113), losing the symbiotic algae that give them both colour and life. [Kelp forests collapse](https://doi.org/10.1038/s41558-019-0412-1), reducing habitat for countless marine species. Fish populations migrate to cooler waters, [disrupting fisheries and coastal economies](https://doi.org/10.1016/j.scitotenv.2024.176558). These aren't abstract ecological concerns: they're real impacts affecting coastal communities and marine industries worldwide.
...
Sustained, high-resolution observations are essential for monitoring these events, understanding their drivers, and improving our ability to predict them. [The dataset from the 2023 deployment](https://doi.org/10.5281/zenodo.15831373), offers researchers valuable data for model validation, diurnal warming studies, and data assimilation efforts. 
...
*This post discusses data presented in "[Sea Surface Temperature and Directional Wave Spectra During the 2023 Marine Heatwave in the North Atlantic](https://doi.org/10.1038/s41597-025-06268-y)" published in Scientific Data.*
